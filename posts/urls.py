...
urlpatterns = [
    ...
    path('posts/<str:keyword>', views.post_list_keyword_query_posted_date_order),
    path('posts/<str:keyword>/<int:food_score>', views.post_list_keyword_score_query_posted_date_order),
